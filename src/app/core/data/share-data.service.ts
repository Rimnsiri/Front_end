...
export class ShareDataService {
 ...
 public sideBar : header[] = [
    {
      tittle: "Domaines d'expertise",
      base: '',
      showAsTab: false,
      separateRoute: false,
      route: '#domaines_expertise',
      menu: [],
      fragment:'domaines_expertise'
    },
    {
      tittle: 'Entreprises',
      base: '',
  ...
  public menuItem = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Ajouter Note', routes: routes.employee_invitedfavourites , page: 'invitedfavourites',},
      ],
    },
    {
      title: 'Reviews',
    ...
    },
    {
      ...
      submenu: [
        { title: 'Paramètres De Profil', routes: routes.employee_basic_settings,page:'basic-settings' },
        { title: 'Changer mot de passe', routes: routes.changepassword ,page: 'change-password'},
        { title: 'Changer mot de passe', routes: routes.deleteaccount ,page:'delete-account'},
      ],
    },
    {
      title: 'Logout',
