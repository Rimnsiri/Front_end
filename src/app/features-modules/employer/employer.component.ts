...
export class EmployerComponent  {
  ...
  shouldDisplaySidemenu(): boolean {
    const pathsToExclude = ['developer-details', 'developer', 'developer-list','test','chats'];
    return !pathsToExclude.some(path => this.Router.url.includes(path));
  }
